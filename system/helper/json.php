 ...
 *
 * Contains several functions to manipulate a json-string.
 *
...
/**
 * Provides json_encode functionality if not built-in.
 * 
...
/**
 * Provides json_decode functionality if not built-in.
 * 
 * @param string $json The string that will be decoded.
 * @param boolean $assoc Boolean flag for associative decoding.
 *
 * @return array
 * 
 */
