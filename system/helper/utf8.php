 ...
 *
 * Contains several functions to manipulate an utf-8 string.
 *
...
/**
 * Function utf8_strlen returns the length of an utf-8 decoded string.
 * 
 * @param string $string The string that will be counted.
 *
 * @return int
 * 
 */
...
/**
 * Function utf8_strpos returns the position of needle within a utf-8 string.
 * 
 * @param string $string The string that will be searched.
 * @param string $needle The string that will be searched for.
 * @param int $offset A possible offset to be used.
 *
 * @return int
 * 
 */
...
/**
 * Function utf8_strrpos returns the position of needle within a utf-8 string.
 * 
 * @param string $string The string that will be searched.
 * @param string $needle The string that will be searched for.
 * @param int $offset A possible offset to be used.
...
/**
 * Function utf8_substr returns a part of an utf-8 string.
 * 
 * @param string $string The string that will be searched.
 * @param int $offset The offset to be used.
 * @param int $length A possible length.
 *
 * @return string
 * 
 */
...
/**
 * Function utf8_strtolower returns an all lowercase utf-8 string.
 * 
 * @param string $string The string that needs to be converted to lowercase
 *
 * @return string
 * 
 */
...
/**
 * Function utf8_strtoupper returns an all uppercase utf-8 string.
 * 
 * @param string $string The string that needs to be converted to uppercase
 *
 * @return string
 * 
 */
...
/**
 * Function utf8_to_unicode converts an utf-8 string to a unicode-string.
 * 
 * @param string $str The string that needs to be converted to unicode
 *
 * @return array
 * 
 */
...
/**
 * Function utf8_from_unicode converts a unicode-string to an utf-8 string.
 * 
 * @param array $arr The array that needs to be converted to utf-8
 *
 * @return string
 * 
 */
