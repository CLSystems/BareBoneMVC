...
final class Pagination {
	...
	public $text_first = '<img src=view/image/resultset_first.png />'; // '|&lt;';
	public $text_last = '<img src=view/image/resultset_last.png />'; // '&gt;|';
	public $text_next = '<img src=view/image/resultset_next.png />'; // '&gt;';
	public $text_prev = '<img src=view/image/resultset_previous.png />'; // '&lt;';
