      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <?php if ($altclasses) { ?>
				<?php $class = 'odd'; ?>
				<?php foreach ($altclasses as $altclass) { ?>
					<?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
					<tr class="<?php echo $class; ?>">
					  <td style="text-align: center;"><?php if ($altclass['selected']) { ?>
						<input type="checkbox" name="selected[]" value="<?php echo $altclass['v_a_c_id']; ?>" checked="checked" />
						<?php } else { ?>
						<input type="checkbox" name="selected[]" value="<?php echo $altclass['v_a_c_id']; ?>" />
						<?php } ?></td>
					  <td class="left"><?php echo $altclass['airline_code']; ?></td>
					  <td class="left"><?php echo $altclass['name']; ?></td>
					  <td class="left"><?php echo html_entity_decode($altclass['description']); ?></td>
					  <td class="right"><?php foreach ($altclass['action'] as $action) { ?>
...
function filter() {
	url = 'index.php?route=maintenance/altclasses&token=<?php echo $token; ?>';
