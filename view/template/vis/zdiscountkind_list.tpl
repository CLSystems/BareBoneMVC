				...
				<?php foreach ($discounts as $discount) { ?>
					...
					<tr class="<?php echo $class; ?>">
					  <td style="text-align: center;"><?php if ($discount['selected']) { ?>
						<input type="checkbox" name="selected[]" value="<?php echo $discount['discount_kind_id']; ?>" checked="checked" />
						<?php } else { ?>
						<input type="checkbox" name="selected[]" value="<?php echo $discount['discount_kind_id']; ?>" />
						<?php } ?></td>
