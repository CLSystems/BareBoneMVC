      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <?php if ($altseats) { ?>
				<?php $class = 'odd'; ?>
				<?php foreach ($altseats as $altseat) { ?>
					<?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
					<tr class="<?php echo $class; ?>">
					  <td style="text-align: center;"><?php if ($altseat['selected']) { ?>
						<input type="checkbox" name="selected[]" value="<?php echo $altseat['v_a_s_r_id']; ?>" checked="checked" />
						<?php } else { ?>
						<input type="checkbox" name="selected[]" value="<?php echo $altseat['v_a_s_r_id']; ?>" />
						<?php } ?></td>
					  <td class="left"><?php echo $altseat['airline_code']; ?></td>
					  <td class="left"><?php echo $altseat['name']; ?></td>
					  <td class="left"><?php echo html_entity_decode($altseat['description']); ?></td>
					  <td class="right"><?php foreach ($altseat['action'] as $action) { ?>
...
function filter() {
	url = 'index.php?route=maintenance/altseats&token=<?php echo $token; ?>';
