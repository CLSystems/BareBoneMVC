      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <?php if ($cabincategories) { ?>
			<?php $class = 'odd'; ?>
            <?php foreach ($cabincategories as $cabincategory) { ?>
            <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
			<tr class="<?php echo $class; ?>">
              <td style="text-align: center;"><?php if ($cabincategory['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $cabincategory['cabin_category_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $cabincategory['cabin_category_id']; ?>" />
                <?php } ?></td>
              <td class="left"><?php echo $cabincategory['cabin_category_name']; ?></td>
			  
              <td class="right"><?php foreach ($cabincategory['action'] as $action) { ?>
...
function filter() {
	url = 'index.php?route=maintenance/cabincategory&token=<?php echo $token; ?>';
